...
population_2020 = population_2020.drop(columns=['Unnamed: 3']) #remove weird column
...
```{python}
merged_district_gdf = merged_district_gdf.merge(district_population, on='District', how='left')
